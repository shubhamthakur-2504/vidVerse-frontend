...
export default function Sidebar() {
    ...
    return (
        <div className={`flex flex-row md:flex-col h-[8vh] pb-2 pr-3 pl-3 md:h-screen md:m-2 w-screen bg-[#121212] items-center md:justify-start justify-between  md:gap-8 ${isOpen ? "md:w-[10vw] items-center transition-all duration-300 " : "md:w-[5vw] transition-all duration-400"} `}>

            <Link href={"/"}>
                <div className={`md:mt-[4vh] ${isActive("/") ? " rounded-2xl shadow-2xl relative " : ""} `}>
            ...
            <Link href={"/tweet"}>
                <div className={`${isActive("/tweet") ? " rounded-2xl shadow-2xl" : ""}`}>
            ...
            <Link href={"/subscribed"}>
                <div className={`${isActive("/subscribed") ? " rounded-2xl shadow-2xl " : ""}`}>
